...
contract Liqudity {
    ...
    mapping (address => LiqudityInfo[]) public liquidities;
    uint public liquidityID;
    ...
    function addLiquidity(
        ...
        liquidities[msg.sender].push(LiqudityInfo({
    ...
    function getAllLiquidity(address _address)public view returns(LiqudityInfo[] memory){
