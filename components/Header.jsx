        ...
        <div className="header-content-wrapper">
          ...
          <nav id="primary-menu" className="primary-menu">
            <ul className="primary-menu-menu">
              ...
              <li onClick={() => setOpenAddPool(true)} className="menu-item-has-children">
                <a>Add Pool</a>
              </li>
              <li onClick={() => setOpenAllLiquidity(true)} className="menu-item-has-children">
                <a>Add Liquidity</a>
              </li>
              ...
              {address ? (
                ...
                <a onClick={() => connect()} className="btn btn--large btn--primary btn--transparent">
                  Connect
                </a>
              )}
            </ul>
