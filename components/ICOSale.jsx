        ...
        <div className="row bg-2">
          <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb30">
            <header className="crumina-module crumina-heading heading--h2 heading--with-decoration">
              <img src="img/dots.png" alt="" className="responsive-dots mb30" />
              ...
              <div className="heading-text">
                ...
                facilis iure? Error odit maiores quod ex fugit,
              </div>
            </header>
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Eligendi, praesentium ab, nobis accusamus temporibus molestias
              sapiente laboriosam reprehenderit ut adipisci odio, quaerat minima
              ipsum. Quo, facilis? Doloremque eligendi voluptatibus
              repellat.molestias sapiente laboriosam reprehenderit ut adipisci
              odio, quaerat minima ipsum. Quo, facilis? Doloremque eligendi
              voluptatibus repellat.molestias sapiente laboriosam reprehenderit
              ut adipisci odio, quaerat minima ipsum. Quo, facilis? Doloremque
              eligendi voluptatibus repellat.
            </p>
          ...
          <div className="col-lg-6 col-md-12 col-slg-offset-0 col-sm-12 col-xs-12">
