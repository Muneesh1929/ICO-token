      ...
      <div className="row">
        <div className="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0 col-xs-12">
          <div className="widget w-info">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae, dicta ab quisquam debitis illum quia consectetur ullam quae inventore. Magni voluptatum natus odit officiis esse nobis totam voluptate voluptates minima.
          ...
          <div className="widget w-contacts">
            ...
            <li key={index} className="social-item">
              <a href={social.link} className="woox-icon">{social.icon}</a>
            </li>
              ))}
            </ul>
          </div>
      ...
      <div className="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0 col-xs-12">
        ...
        <div className="logo-design">
          ...
          <div className="design-wrap">
            ...
            <a href="https://www.instagram.com/_ermack__/?igsh=MmZrcWZxbXMwaGVh" className="logo-title">
              @ermackblockchain
            </a>
          </div>
        </div>
