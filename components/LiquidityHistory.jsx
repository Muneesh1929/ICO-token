      ...
      <div className="container">
        <div className="row medium-padding120">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="mCustomScrollbar scrollable-responsive-table overflow-y" data-msc-theme="dark">
              <table className="pricing-table-wrap-table-blurring">
                ...
                <tbody>
                  {
                    liquidity?.map((liquidity, index) => (
                      <tr key={index + 1} className="crumina-module crumina-pricing-table pricing-table--style-table-blurring c-brown">
                        <td>{index + 1}</td>
                        <td>
                        ...
                        <td>
                          <div className="currency-details-item">
                            <div onClick={() => navigator.clipboard.writeText(liquidity?.tokenA_Address
                            )
                            }
                        ...
                        <td>
                          <div className="currency-details-item">
                            <div onClick={() => navigator.clipboard.writeText(liquidity?.tokenB_Address
                            )
                            }
                        ...
                        <td>
                          <div className="currency-details-item">
                            <div onClick={() => navigator.clipboard.writeText(liquidity?.poolAddress)}
                              className={`value `}>
                ...
                <tfoot>
                  <tr>
                    <td colSpan={"8"}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Lorem ipsum dolor sit amet, consectetur adipiscing elit.Lorem ipsum dolor sit amet, consectetur adipiscing elit.Lorem ipsum dolor sit amet, consectetur adipiscing elit.Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    </td>
                  </tr>
                </tfoot>
              </table>
