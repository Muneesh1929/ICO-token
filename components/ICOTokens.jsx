...
const ICOTokens = () => {
  return (<section className="medium-padding100">
            ...
            <div className="swiper-container" data-show-items="3" data-prev-next="1">
              <div className="new_flex">
                <div className="swiper-slide">
                  <div className="crumina-module crumina-pricing-table pricing-table--small">
                    <div className="pricing-thumb">
                      <img src="img/if_Bitcoin_2745023.png" className="woox-icon" alt="" />
                    ...
                    <div className="price">
                      ...
                      <div className="price-value">$94772.3
                ...
                <div className="swiper-slide">
                  <div className="crumina-module crumina-pricing-table pricing-table--small">
                    <div className="pricing-thumb">
              <img src="img/if_etherium_eth_ethcoin_crypto_2844386.png" className="woox-icon" alt="" />
                      <h5 className="pricing-title">
                    ...
                    <div className="price">
                      <div className="price-sup-title">1 Ethereum equals:</div>

                      <div className="price-value">$54772.3
                ...
                <div className="swiper-slide">
                  <div className="crumina-module crumina-pricing-table pricing-table--small">
                    <div className="pricing-thumb">
                      <img src="img/if_dash_dashcoin_2844383.png" className="woox-icon" alt="" />
                      <h5 className="pricing-title">
                        Dash <span>Dash</span>
                      </h5>
                      <div className="gain-drop-arrow">
                    ...
                    <div className="price">
                      ...
                      <div className="price-value">$72.3
